package com.patterns.creationalpatterns.builder.before;
...
public class TourPlan {
	...
	public String toString() {
		return "TourPlan [title=" + title + ", nights=" + nights + ", days=" + days + ", startDate=" + startDate
				+ ", whereToStay=" + whereToStay + ", plans=" + plans + "]";
	}
